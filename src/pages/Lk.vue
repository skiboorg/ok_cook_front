...
<q-tabs
        ...
        <q-tab-panels v-model="tab" animated class="bg-grey-2">
          <q-tab-panel name="personal">
            ...
            <span class="link text-caption text-primary cursor-pointer">скопировать</span></p>
            <q-form >
              <p>Тип плательщика</p>
                <q-option-group
                  :options="userType"
        ...
        >
          ...
          <q-item>
            <q-item-section side class="q-mr-lg ">Состав заказа</q-item-section>
            <q-item-section>
          ...
          <q-tab-panel name="refferal">
            <div class="text-h6">В разработке</div>
